...
- **75 stories done** (all tested, committed)
...
| MEDIA-722 | TV On-Screen Keyboard & Search (Vue)     | 3 pts  | ✅ Done    | MEDIA-720, MEDIA-721, MEDIA-710 |
| MEDIA-723 | Pi Provisioning & Setup Automation       | 3 pts  | ✅ Done    | MEDIA-720, MEDIA-721            |
...
| Story     | Title                                     | Effort | Status     | Depends on           |
| --------- | ----------------------------------------- | ------ | ---------- | -------------------- |
| MEDIA-731 | Player Crash Recovery & Auto-Reconnect    | 3 pts  | ✅ Done    | MEDIA-725, MEDIA-734 |
...
| Story     | Title                                           | Effort | Status     | Depends on           |
| --------- | ----------------------------------------------- | ------ | ---------- | -------------------- |
| MEDIA-730 | Multi-Device Audio — Separate Playback Sessions | 8 pts  | ✅ Done    | MEDIA-711, MEDIA-701 |
