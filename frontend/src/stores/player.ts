...
export interface SSEEventPayloads {
  ...
  'item-added': { id: string; title: string; url: string; addedByUserId?: string; addedByName?: string }
...
export const usePlayerStore = defineStore('player', () => {
  ...
  function handlePollState(data: unknown) {
    const d = data as { state?: PlayerState; currentItem?: QueueItemResponse; position?: number; duration?: number }
